...
model <- bvl_addNode(model, "Grp1", "mul")
model <- bvl_addNode(model, "Grp2", "mul")
...
model <- bvl_addArc(model, "VB", "Grp1", "mul")
model <- bvl_addArc(model, "VT", "Grp1", "mul")
model <- bvl_addArc(model, "VC", "Grp2", "mul")
model <- bvl_addArc(model, "VT", "Grp2", "mul")
